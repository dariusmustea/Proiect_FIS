      ...
      <Container>
        <Row>
          <Col lg="4" md="4" sm="12">
            ...
            with our exclusive collection of luxury vehicles.
            </p>
          </Col>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">Monaco 12A</p>
              <p className="office__info">Phone: +40754623454</p>

              <p className="office__info">Email: luxury_rent@gmail.com</p>

              <p className="office__info">Program: 8 - 16</p>
            </div>
          </Col>
